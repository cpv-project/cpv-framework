...
TEST(UUIDUtils, makeMinTimeUUID) {
...
TEST(UUIDUtils, makeMaxTimeUUID) {
	cpv::UUIDDataType uuid = cpv::makeTimeUUID();
...
TEST(UUIDUtils, getVersionFromUUID) {
...
TEST(UUIDUtils, getTimeFromUUID) {
	cpv::UUIDDataType uuid = cpv::makeTimeUUID();
